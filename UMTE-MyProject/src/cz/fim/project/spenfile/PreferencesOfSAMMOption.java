...
public class PreferencesOfSAMMOption extends PreferenceActivity implements OnSharedPreferenceChangeListener {
	...
	public static final String 		PREF_KEY_ENCODE_FOREGROUNDIMAGE = "samm_encode_foreground_image";
	public static final String 		PREF_KEY_ENCODE_THUMBNAILIMAGE = "samm_encode_thumbnail_image";
	public static final String		PREF_KEY_ENCODE_OBJECTDATA = "samm_encode_object_data";
	public static final String		PREF_KEY_ENCODE_VIDEOFILEDATA = "samm_encode_video_file_data";

	public static final String		PREF_KEY_LOAD_DECODE_PRIORITY_FGDATA = "samm_decode_priority_fg";
	...
	private CheckBoxPreference mCheckPreferenceEncodeObjectData;
	private ListPreference mListPreferenceDecodePriorityFGData;
	private CheckBoxPreference mCheckPreferenceEncodeVideoFileData;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mCheckPreferenceEncodeForegroundImage = (CheckBoxPreference)getPreferenceScreen().findPreference(PREF_KEY_ENCODE_FOREGROUNDIMAGE);
		mCheckPreferenceEncodeThumbnailImage = (CheckBoxPreference)getPreferenceScreen().findPreference(PREF_KEY_ENCODE_THUMBNAILIMAGE);
		mCheckPreferenceEncodeObjectData = (CheckBoxPreference)getPreferenceScreen().findPreference(PREF_KEY_ENCODE_OBJECTDATA);
		mListPreferenceDecodePriorityFGData = (ListPreference)getPreferenceScreen().findPreference(PREF_KEY_LOAD_DECODE_PRIORITY_FGDATA);
		mCheckPreferenceEncodeVideoFileData = (CheckBoxPreference)getPreferenceScreen().findPreference(PREF_KEY_ENCODE_VIDEOFILEDATA);
	...
	public void updatePreferences()
	{
		...
		updatePreference(PREF_KEY_ENCODE_FOREGROUNDIMAGE);
		updatePreference(PREF_KEY_ENCODE_THUMBNAILIMAGE);
		updatePreference(PREF_KEY_ENCODE_OBJECTDATA);
		updatePreference(PREF_KEY_LOAD_DECODE_PRIORITY_FGDATA);
		updatePreference(PREF_KEY_ENCODE_VIDEOFILEDATA);
	}
	...
	public void updatePreference(String key)
	{
		...
		if (key.equals(PREF_KEY_LOAD_CANVAS_SIZE)) {
			...
			if(!mCheckPreferenceEncodeObjectData.isChecked())
				mCheckPreferenceEncodeObjectData.setSummaryOff(getResources().getString(R.string.encode_object_data_off));
			else
				mCheckPreferenceEncodeObjectData.setSummaryOn(getResources().getString(R.string.encode_object_data_on));
			...
			if(!mCheckPreferenceEncodeVideoFileData.isChecked())
				mCheckPreferenceEncodeVideoFileData.setSummaryOff(getResources().getString(R.string.encode_video_file_data_off));
			else
				mCheckPreferenceEncodeVideoFileData.setSummaryOn(getResources().getString(R.string.encode_video_file_data_on));
		}
	}
	...
	{
		SharedPreferences prefs=PreferenceManager.getDefaultSharedPreferences(context);
		return prefs.getBoolean(PREF_KEY_ENCODE_FOREGROUNDIMAGE, false);	// default
	}
	...
	{
		SharedPreferences prefs=PreferenceManager.getDefaultSharedPreferences(context);
		return prefs.getBoolean(PREF_KEY_ENCODE_THUMBNAILIMAGE, false);	// default
	}

	// Encode object data
	public static final boolean getPreferenceEncodeObjectDataFile(Context context)
	{
		SharedPreferences prefs=PreferenceManager.getDefaultSharedPreferences(context);
		return prefs.getBoolean(PREF_KEY_ENCODE_OBJECTDATA, true);	// default
	}

	// Return decode priority order (FG)
	public static final int getPreferenceDecodePriorityFGData(Context context)
	{
		SharedPreferences prefs=PreferenceManager.getDefaultSharedPreferences(context);
		String strSaveImageQualityPref = prefs.getString(PREF_KEY_LOAD_DECODE_PRIORITY_FGDATA, "0");	// default
		return Integer.parseInt(strSaveImageQualityPref);
	}

	// Encode video file data
	public static final boolean getPreferenceEncodeVideoFileData(Context context)
	{
		SharedPreferences prefs=PreferenceManager.getDefaultSharedPreferences(context);
		return prefs.getBoolean(PREF_KEY_ENCODE_VIDEOFILEDATA, true);	// default
	}
